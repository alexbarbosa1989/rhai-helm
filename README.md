...
### Curren procedure is to serve VLLM with an OCI modelcar image located in an image repository (default registry for current Helm chart is registry.redhat.io).
